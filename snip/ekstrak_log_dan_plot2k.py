...
if __name__ == '__main__':
    ...
    f = load_file_ekstrak_layer_epoch_cost("../thesis/dataset/logout2000e_3k_2k_1k_100.txt")
    ...
    plt.ylabel("Cost")
    plt.xlabel("Epoch")
    plt.title("Pretraining model 3k_2k_1k_100 Layer 2 (2000 Hidden)")
    ...
    f = load_file_ekstrak_layer_epoch_cost("../thesis/dataset/logout2000e_7k_10k_5k_1k.txt")
    ekstraktor = eks.Ekstraktor()
    #
    # # ekstraktor.simpan_data("../thesis/dataset/1000e_3k_2k_1k_100_lyr1",g)
    # # plot layer 1
